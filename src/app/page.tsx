...
export default function Home() {
  return (
    <main className="flex items-center justify-center w-full h-screen bg-indigo-900 text-white font-sans">
      <div className="flex flex-col items-center w-2/6 h-2/4 gap-4 p-4 bg-white text-indigo-900 rounded-lg shadow-lg times-n font-[family-name:var(--font-poppins)]">
